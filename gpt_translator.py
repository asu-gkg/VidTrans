...
def translate(client, english_text, pred, succ):
    prompt = (f"You are a expert in {domain}. Now you are trying to translate a lecture from {src} to"
              ...
              "context. Please only transfer the English sentence the user give you. You don't have to "
